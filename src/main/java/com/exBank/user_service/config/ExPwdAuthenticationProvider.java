...
@Component
public class ExPwdAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public ExPwdAuthenticationProvider(UserRepository userRepository, PasswordEncoder passwordEncoder) {
